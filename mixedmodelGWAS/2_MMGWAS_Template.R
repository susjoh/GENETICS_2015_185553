...
write.table(wald.results, paste0("Waldtest.It_", it.start, "_", it.end, "_", analysis.type, ".txt"), row.names = F, sep = "\t", quote = F)
write.table(effect.results, paste0("EffectRes.It_", it.start, "_", it.end, "_", analysis.type, ".txt"), row.names = F, sep = "\t", quote = F)
